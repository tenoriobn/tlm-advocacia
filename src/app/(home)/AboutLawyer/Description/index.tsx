export default function Description() {
  return (
    ...
    >
      ...
      <p>
        Sua trajetória inclui atuação em empresas, escritórios e cartório, o que
        permite analisar cada caso com mais precisão e identificar soluções
        eficazes.
      </p>
      <p>
        Fundador da TLM Advocacia, atende nas áreas Cível, Consumidor, Saúde,
